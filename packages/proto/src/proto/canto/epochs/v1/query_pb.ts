...
// @generated from file canto/epochs/v1/query.proto (package canto.epochs.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class QueryEpochsInfoRequest extends Message<QueryEpochsInfoRequest> {
  ...
  static readonly typeName = "canto.epochs.v1.QueryEpochsInfoRequest";
...
/**
 * @generated from message canto.epochs.v1.QueryEpochsInfoResponse
 */
export class QueryEpochsInfoResponse extends Message<QueryEpochsInfoResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "canto.epochs.v1.QueryEpochsInfoResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message canto.epochs.v1.QueryCurrentEpochRequest
 */
export class QueryCurrentEpochRequest extends Message<QueryCurrentEpochRequest> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "canto.epochs.v1.QueryCurrentEpochRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message canto.epochs.v1.QueryCurrentEpochResponse
 */
export class QueryCurrentEpochResponse extends Message<QueryCurrentEpochResponse> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "canto.epochs.v1.QueryCurrentEpochResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
